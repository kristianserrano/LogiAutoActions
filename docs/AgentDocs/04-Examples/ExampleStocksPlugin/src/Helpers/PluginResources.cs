namespace Loupedeck.ExampleStocksPlugin
{
    using System;
    using System.IO;
    ...
    internal static class PluginResources
    {
        ...
        // The parameter `folderName` must be specified as a full path, for example, `Loupedeck.ExampleStocksPlugin.Resources`.
        // Returns the full names of the resource files, for example, `Loupedeck.ExampleStocksPlugin.Resources.Resource.txt`.
