namespace Loupedeck.Test6Plugin
{
    ...
    internal static class PluginResources
    {
        ...
        // The parameter `folderName` must be specified as a full path, for example, `Loupedeck.%%PluginName%%.Resources`.
        // Returns the full names of the resource files, for example, `Loupedeck.%%PluginName%%.Resources.Resource.txt`.
